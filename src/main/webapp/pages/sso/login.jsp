	            	...
	            	<div class="col-md-16 login_down">
	            	  <c:if test="${not empty sessionScope.openIdLocalId}">
		                  <input  class="form-control" id="username" name="username" type="text" placeholder="请输入用户名" 
		                  		onblur="hide('username','请输入用户名')" onfocus="show('username','请输入用户名')" value="${sessionScope.openIdLocalId}">
             		   </c:if>
             		   <c:if test="${empty sessionScope.openIdLocalId}">
						 <input  class="form-control" id="username" name="username" type="text" placeholder="请输入用户名" 
		                  		onblur="hide('username','请输入用户名')" onfocus="show('username','请输入用户名')" >
						</c:if>
	                </div>
	                
	            	<div class="col-md-16 login_down">
	                  <input  class="form-control" id="password"  name="password"  type="password"  placeholder="请输入密码" 
	                  		onblur="hide('password','请输入密码')" onfocus="show('password','请输入密码')"> 
	                </div>
